...
class Habit(models.Model):
    ...
    is_public = models.CharField(
        max_length=1,
        default=IsPublicHabit.PRIVATE,
        choices=IsPublicHabit,
    ...
    last_performed = models.DateField(
        verbose_name="Дата последнего выполнения", **NULLABLE
    )
    execution_interval_day = models.PositiveIntegerField(
    ...
    def __str__(self):
        return (
            f"{self.id}|{self.title}|{self.action}|{self.time_action}|"
